...
<template>
    <header class="my-5 rounded-lg bg-[#6A9C89] " >
        <div class="w-full text-white text-md flex p-5 justify-between transition-all duration-150" >
        ...
        <div class="w-4/6 mx-auto flex flex-col  p-5 items-center justify-between">
